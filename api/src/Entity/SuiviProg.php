...
#[ORM\UniqueConstraint(name: 'uniq_session_joueur_minijeu', columns: ['session_joueur_id', 'mini_jeu_id'])]
class SuiviProg
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    public function getNbCosmetiqueAtt(): int { return $this->nbCosmetiqueAtt; }
    public function setNbCosmetiqueAtt(int $nbCosmetiqueAtt): static { $this->nbCosmetiqueAtt = $nbCosmetiqueAtt; return $this; }
    public function getNbNonCosmetiqueAtt(): int { return $this->nbNonCosmetiqueAtt; }
    public function setNbNonCosmetiqueAtt(int $nbNonCosmetiqueAtt): static { $this->nbNonCosmetiqueAtt = $nbNonCosmetiqueAtt; return $this; }
    public function isAGagneCode(): bool { return $this->aGagneCode; }
    public function setAGagneCode(bool $aGagneCode): static { $this->aGagneCode = $aGagneCode; return $this; }
    ...
    public function getMiniJeu(): ?MiniJeu { return $this->miniJeu; }
    public function setMiniJeu(?MiniJeu $miniJeu): static { $this->miniJeu = $miniJeu; return $this; }
}
